...
class SkillSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $skill = [
            ...
            ['name' => 'Mecanico automotriz', 'photo' => 'mecanicoAutomotriz.png', 'icons' => 'construct'],
            ...
            ['name' => 'Cocinero', 'photo' => 'cocinero.png', 'icons' => 'restaurant-sharp'],
            ['name' => 'Cerrajero', 'photo' => 'Copiadellaves.png' , 'icons' => 'key-chain-variant'],
            ['name' => 'Pintor de obras', 'photo' => 'pintorObras.png', 'icons' => 'color-fill-outline'],
            ['name' => 'Fumigador', 'photo' => 'fumigacion.png', 'icons' => 'nuclear-sharp'],
            ['name' => 'Vidriero', 'photo' => 'vidriero.png', 'icons' => 'google-glass'],
            ['name' => 'Tecnico en computacion', 'photo' => 'computacion.png', 'icons' => 'desktop-outline'],
            ['name' => 'Tecnico en redes electricas', 'photo' => 'tecnicoRedesElectrica.png', 'icons' => 'flash-outline'],
            ['name' => 'Tecnico en electrodomesticos', 'photo' => 'electrodomesticos.png', 'icons' => 'briefcase-sharp'],
            ...
            ['name' => 'Bartender / Barman', 'photo' => 'BarradebebidasLicoreria.png', 'icons' => 'wine-sharp'],
            ['name' => 'Vocalista', 'photo' => 'Grupomusicalmariachibandas.png', 'icons' => 'microphone-message'],
            ['name' => 'Operador de grua', 'photo' => 'Serviciodegrua.png', 'icons' => 'logo-steam'],
            ['name' => 'Zapatero / Reparador de calzado', 'photo' => 'zapatero.png', 'icons' => 'fa-boot'],
        ];
