...
class SkillSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $skill = [
            ...
            ['name' => 'Albanileria', 'photo' => 'albanil.png', 'icons' => 'hammer-screwdriver'],
            ['name' => 'Cocinero', 'photo' => 'cocinero.png', 'icons' => 'chef-hat'],
            ['name' => 'Cerrajero', 'photo' => 'Copiadellaves.png' , 'icons' => 'key-chain-variant'],
            ['name' => 'Pintor de obras', 'photo' => 'pintorObras.png', 'icons' => 'format-color-fill'],
            ['name' => 'Fumigador', 'photo' => 'fumigacion.png', 'icons' => 'sprinkler-variant'],
            ['name' => 'Vidriero', 'photo' => 'vidriero.png', 'icons' => 'google-glass'],
            ['name' => 'Tecnico en computacion', 'photo' => 'computacion.png', 'icons' => 'cable-data'],
            ['name' => 'Tecnico en redes electricas', 'photo' => 'tecnicoRedesElectrica.png', 'icons' => 'lightning-bolt-circle'],
            ['name' => 'Tecnico en electrodomesticos', 'photo' => 'electrodomesticos.png', 'icons' => 'fridge-alert-outline'],
            ...
            ['name' => 'Piscenero', 'photo' => 'PiscineroJardineria.png', 'icons' => 'pool'],
            ...
            ['name' => 'Operador de grua', 'photo' => 'Serviciodegrua.png', 'icons' => 'fa-truck-crane'],
