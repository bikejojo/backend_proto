...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('notifications', function (Blueprint $table) {
            ...
            //['solicitud', 'servicio' , 'promocion', 'publicidad' , 'suscripcion' , 'password' , 'recordatorio']);
            $table->enum('status', [ 1 , 2 , 3 , 4 , 5 , 6 , 7 , 8])->default(1);
            //['pendiente', 'enviada', 'aceptado', 'cancelada' , 'anulado','completado','terminado','cancelado por sistema'])->default('pendiente');
